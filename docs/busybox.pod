...
Currently available applets include:
	...
	[, [[, add-shell, ash, awk, base64, basename, blkid, blockdev,
	bunzip2, bzcat, bzip2, cal, cat, catv, chattr, chgrp, chmod, chown,
	chroot, chrt, cksum, cmp, comm, cp, cttyhack, cut, date, dd, depmod,
	devmem, df, dhcprelay, dirname, dmesg, dnsdomainname, dos2unix, du,
	dumpleases, echo, ed, egrep, eject, env, expand, expr, false, fdisk,
	fgrep, find, flock, fold, free, fsck, fstrim, fsync, ftpget, ftpput,
	grep, groups, gunzip, gzip, halt, hd, head, hexdump, hostid,
	hostname, hwclock, id, ifconfig, ifdown, ifup, init, insmod,
	install, iostat, ip, ipaddr, iplink, iproute, iprule, iptunnel,
	kill, killall, killall5, ln, logname, losetup, ls, lsattr, lsmod,
	lsof, lsusb, lzop, lzopcat, md5sum, mdev, mesg, mkdir, mkdosfs,
	mke2fs, mkfifo, mkfs.ext2, mkfs.vfat, mknod, mktemp, modinfo,
	modprobe, more, mount, mpstat, mv, nanddump, nandwrite, netstat,
	nice, nohup, nslookup, od, pidof, ping, ping6, pkill, pmap,
	poweroff, powertop, printenv, printf, ps, pstree, pwd, pwdx, rdate,
	readlink, realpath, reboot, remove-shell, renice, rm, rmdir, rmmod,
	route, run-parts, sed, seq, setserial, sh, sha1sum, sha256sum,
	sha3sum, sha512sum, sleep, sort, split, start-stop-daemon, stat,
	stty, sum, switch_root, sync, sysctl, tac, tail, tar, tee, test,
	time, top, touch, tr, traceroute, traceroute6, true, tty, ubimkvol,
	ubirmvol, ubirsvol, ubiupdatevol, udhcpc, udhcpd, umount, uname,
	unexpand, uniq, unix2dos, unlzop, uptime, users, usleep, uudecode,
	uuencode, vi, wc, wget, which, who, whoami, whois, yes, zcat
