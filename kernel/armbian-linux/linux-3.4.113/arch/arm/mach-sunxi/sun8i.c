...
#endif
#if defined(CONFIG_SUNXI_ATARI_KEY)
static struct i2c_board_info bte_i2c_board_info[] = {
        {I2C_BOARD_INFO("bte_i2c", 0x52), }
};
#endif
...
#if defined(CONFIG_SUNXI_ATARI_KEY)
	if (i2c_register_board_info(0, bte_i2c_board_info, ARRAY_SIZE(bte_i2c_board_info)) < 0){
		printk("stanley bte_i2c register failed\n");
	}
	printk("stanley bte_i2c registered\n");
#endif
#ifdef CONFIG_ANDROID_RAM_CONSOLE
