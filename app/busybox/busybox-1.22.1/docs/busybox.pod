...
Currently available applets include:
	...
	[, [[, add-shell, arp, ash, awk, base64, basename, blkid, blockdev,
	bunzip2, bzcat, bzip2, cal, cat, catv, chgrp, chmod, chown, chroot,
	chrt, cksum, cmp, comm, cp, cttyhack, cut, date, dd, depmod, devmem,
	df, dirname, dmesg, dnsdomainname, dos2unix, du, echo, ed, egrep,
	env, expand, expr, false, fgrep, find, flock, fold, free, fsync,
	ftpget, ftpput, grep, groups, gunzip, gzip, halt, hd, head, hexdump,
	hostid, hostname, hwclock, id, ifconfig, ifdown, ifup, init, insmod,
	install, iostat, ip, ipaddr, iplink, iproute, iprule, iptunnel,
	kill, killall, killall5, less, ln, logname, losetup, ls, lsmod,
	lsof, lsusb, lzop, lzopcat, md5sum, mdev, mesg, mkdir, mkdosfs,
	mkfifo, mkfs.vfat, mknod, mktemp, modinfo, modprobe, more, mount,
	mpstat, mv, nc, netstat, nice, nohup, nslookup, od, passwd, pidof,
	ping, pkill, pmap, poweroff, powertop, printenv, printf, ps, pstree,
	pwd, pwdx, rdate, readlink, realpath, reboot, remove-shell, renice,
	reset, rm, rmdir, rmmod, route, run-parts, sed, seq, setserial, sh,
	sha1sum, sha256sum, sha3sum, sha512sum, sleep, sort, split,
	start-stop-daemon, stat, stty, sum, switch_root, sync, sysctl, tac,
	tail, tar, tee, test, time, top, touch, tr, traceroute, true, tty,
	udhcpc, umount, uname, unexpand, uniq, unix2dos, unlzop, uptime,
	users, usleep, uudecode, uuencode, vi, wc, wget, which, who, whoami,
	whois, yes, zcat
